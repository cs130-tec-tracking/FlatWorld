...
namespace Zenject.Asteroids
{
    public class GameInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            TextAsset environmentJson = Resources.Load("AppEnvironmentDev") as TextAsset;
            Debug.LogWarning(environmentJson.text);
           
            EnvironmentConfig environmentConfig = JsonConvert.DeserializeObject<EnvironmentConfig>(environmentJson.text);
            Container.Bind<Stage.App.Environment>().AsSingle()
                      .WithArguments(environmentConfig);

            Container.Bind<SignupService>( ).AsSingle( );
//            InstallAsteroids();
//            InstallShip();
//            InstallMisc();
//            InitExecutionOrder();
        ...
        void InstallAsteroids()
        {
            ...
            // IFixedTickable, or steroidManager as inputs will receive the same instance of AsteroidManager.
